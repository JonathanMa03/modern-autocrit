...
Once everything is setup, run `python run_pipeline.py`. Logged extraction is printed, and once finished, you get a summary like:
```bash
...
...
Once everything is setup, run `python main.py` to get a stand-alone app.